          ...
          <AnimatePresence mode="popLayout">
            {loading ? (
              <div className="col-span-3 text-center py-10">
                <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#696cff] mx-auto"></div>
              </div>
            ) : posts.map((post) => (
              <motion.article
                key={post.id}
              ...
              >
                <Link href={`/blog/${post.slug}`} className="block">
                  ...
                  <div className="p-6">
                    ...
                    <h2 className="text-xl font-bold text-gray-900 mb-2" itemProp="headline">
                      {post.title}
                    </h2>
                    ...
                    <motion.div whileHover={{ x: 5 }} className="flex items-center gap-2 text-[#696cff] font-medium">
                      Read More
